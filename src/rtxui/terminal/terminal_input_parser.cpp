...
std::optional<Event> TerminalInputParser::ToEvent(std::string_view sequence) {
  static const auto& mapping = *new std::map<std::string, Event>{
      ...
      {"\x1B[1;3D", Event::ArrowLeftAlt()}, {"\x1B[1;3C", Event::ArrowRightAlt()}, {"\x1B[1;3A", Event::ArrowUpAlt()}, {"\x1B[1;3B", Event::ArrowDownAlt()},
      {"\x7F", Event::Backspace()}, {"\x1B\x7F", Event::BackspaceAlt()}, {"\x1B\x08", Event::BackspaceAlt()}, {"\x1B[127;5u", Event::BackspaceCtrl()}, {"\x1B[8;5u", Event::BackspaceCtrl()}, {"\x1B[127;3u", Event::BackspaceAlt()}, {"\x1B[8;3u", Event::BackspaceAlt()},
      {"\x1B[3~", Event::Delete()}, {"\x1B[3;5~", Event::DeleteCtrl()}, {"\x1B[3;3~", Event::DeleteAlt()}, {"\x1B", Event::Escape()}, {"\n", Event::Return()}, {"\r", Event::Return()}, {"\t", Event::Tab()}, {"\x1B[Z", Event::TabReverse()},
