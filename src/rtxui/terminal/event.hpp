...
struct Event {
  ...
  struct Keyboard {
    ...
    enum Special {
      None = 0, ArrowLeft, ArrowRight, ArrowUp, ArrowDown,
      Backspace, Delete, Escape, Return, Tab, TabReverse,
      Insert, Home, End, PageUp, PageDown,
      F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12,
    };
    Special special = None;
    Modifier modifier;
    enum Motion { Pressed, Repeat, Released, };
  ...
  static const Event& Backspace(); static const Event& Delete(); static const Event& Return(); static const Event& Escape();
  ...
  static const Event& F6(); static const Event& F7(); static const Event& F8(); static const Event& F9(); static const Event& F10();
  static const Event& F11(); static const Event& F12();
...
#define RTXUI_DECLARE_LETTER(L, UC) \
  ...
  RTXUI_DECLARE_LETTER(a, A) RTXUI_DECLARE_LETTER(b, B) RTXUI_DECLARE_LETTER(c, C) RTXUI_DECLARE_LETTER(d, D)
  RTXUI_DECLARE_LETTER(e, E) RTXUI_DECLARE_LETTER(f, F) RTXUI_DECLARE_LETTER(g, G) RTXUI_DECLARE_LETTER(h, H)
  RTXUI_DECLARE_LETTER(i, I) RTXUI_DECLARE_LETTER(j, J) RTXUI_DECLARE_LETTER(k, K) RTXUI_DECLARE_LETTER(l, L)
  RTXUI_DECLARE_LETTER(m, M) RTXUI_DECLARE_LETTER(n, N) RTXUI_DECLARE_LETTER(o, O) RTXUI_DECLARE_LETTER(p, P)
  RTXUI_DECLARE_LETTER(q, Q) RTXUI_DECLARE_LETTER(r, R) RTXUI_DECLARE_LETTER(s, S) RTXUI_DECLARE_LETTER(t, T)
  RTXUI_DECLARE_LETTER(u, U) RTXUI_DECLARE_LETTER(v, V) RTXUI_DECLARE_LETTER(w, W) RTXUI_DECLARE_LETTER(x, X)
  RTXUI_DECLARE_LETTER(y, Y) RTXUI_DECLARE_LETTER(z, Z)
...
inline std::ostream& operator<<(std::ostream& os, const Event& event) { os << event.Print(); return os; }
