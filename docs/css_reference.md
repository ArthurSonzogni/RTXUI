...
<CssProperty name="position" values="static | relative | absolute | fixed | sticky" description="Selects positioning flow model. `sticky` honours `top` and `left` only; see the Positioning guide." />
